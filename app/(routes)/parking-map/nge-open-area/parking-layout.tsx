...
import NGEOpenAreatImage from "@/public/nge-open-area-zoomed.png";
...
const ParkingLayout = () => {
  ...
  useEffect(() => {
    const fetchParkingSlots = async () => {
      try {
        const slotsRef = collection(firestore, "NGEpenAreaParkingSlots");
